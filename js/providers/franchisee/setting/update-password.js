$(document).ready(function () {
	...
	$('#changepassword #oldpassword').on('keyup',function () {
	    if ($(this).val() == '') {
			$('#changepassword #oldpassword_err').empty();
		}
	});
            ...
            if ($(form).valid()) {
                ...
                $.ajax({
                    ...
                    success: function (data) {					
						...
						$('#changepassword #updatepwd').find('span').text($update);
    ...
    $('#changepassword #oldpassword').blur(function () {
