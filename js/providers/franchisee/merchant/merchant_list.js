...
/* 	 $('#supplier_list').on('click', '.manage_merchant', function (e) {
        var CurEle = $(this);
		alert(CurEle.data('supplier_id'));
        $('#supp_id').val(CurEle.data('supplier_id'));
        $('#acc_type_id').val(CurEle.data('account_type_id'));
		$('#supplier_id').val(CurEle.data('supplier_id'));
        $('#account_type_id').val(CurEle.data('account_type_id'));
    }); */
