            ...
            success: function (op) {
			  console.log(op);  
				...
				$.each(op, function (k, v) {		
					...
					/* console.log(v.status); return false; */
					if(v.status == true){	
						...
						$(CURFORM).before('<div class="alert alert-success alert-err"><a href="#" class="close" area-label="close" data-dismiss="alert">&times;</a>'+ v.msg + '</div>');
