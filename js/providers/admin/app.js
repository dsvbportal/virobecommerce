            ...
            if (data !== undefined && data.msg !== undefined && data.msg !== '' && data.msg !== null) {
				...
				if (CURFORM!=null && CURFORM.data!==undefined && CURFORM.data('errmsg-fld')!==undefined){
					if(CURFORM.data('errmsg-placement')=='append'){
						$(CURFORM.data('errmsg-fld')).append('<div class="alert alert-success"><a href="#" class="close" area-label="close" data-dismiss="alert">&times;</a>'+ data.msg + '</div>')
					} 
					else if(CURFORM.data('errmsg-placement')=='after')
					{
						$(CURFORM.data('errmsg-fld')).after('<div class="alert alert-success"><a href="#" class="close" area-label="close" data-dismiss="alert">&times;</a>'+ data.msg + '</div>')
					} 
					else {
						$(CURFORM.data('errmsg-fld')).before('<div class="alert alert-success"><a href="#" class="close" area-label="close" data-dismiss="alert">&times;</a>'+ data.msg + '</div>')
					}
					
				} else if (CURFORM!=null){
					$(CURFORM).before('<div class="alert alert-success"><a href="#" class="close" area-label="close" data-dismiss="alert">&times;</a>'+ data.msg + '</div>');
				}
            }
        }
...
function addDropDownMenu(arr, text) {	
    arr = arr || [];
    text = text || false;
    var content = $('<div>', {class: 'btn-group'}).append($('<button>').attr({class: 'btn btn-sm btn-primary dropdown-toggle', 'data-toggle': 'dropdown', 'disabled': (arr != '' ?  false:true)})  
