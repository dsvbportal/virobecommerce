$(document).ready(function () {
    var DT = $('#merchant_enrolment_fee').dataTable({
		 "ordering": false,
		 "bStateSave": true,
        ajax: {
            data: function (d) {
           ...
           columns: [
...

			{
                ...
                render: function (data, type, row, meta) {
                    ...
                    action_buttons += '<li><a href="' + document.location.BASE + 'admin/franchisee/commission/'+row.account_id+'/'+row.from_date+'" target="_blank class="edit_btn" data-category_id">Details</a></li>';
