            ...
            "columns": [						
				...
				/*{
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        var action_buttons = '';
                        action_buttons = '<div class="btn-group"><button type="button" class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button><ul class="dropdown-menu dropdown-menu-right" role="menu">';
