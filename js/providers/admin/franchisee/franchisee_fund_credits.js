                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        if (row.status != 1 && row.status != 5 && (row.payment_status == 0 || row.payment_status == 2 || row.payment_status == 1)) {
                            ...
                            if (action_buttons2 != '') {
                                action_buttons = '<div class="btn-group action_col"><button type="button"  class="btn btn-xs btn-primary details">Action</button><button type="button" class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button><ul class="dropdown-menu dropdown-menu-right" role="menu">';
