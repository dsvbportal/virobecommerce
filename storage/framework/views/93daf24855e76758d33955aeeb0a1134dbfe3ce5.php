<div class="col-sm-12 content-page" id="crop-image"  style="display:none">
    <div class="box box-primary" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="img-container">
                            <img src="<?php echo e(asset('imgs/offers/300/300/offers-1.jpg')); ?>" class="img img-thumbnail col-sm-12" alt="Picture">
                        </div>
                    </div>
