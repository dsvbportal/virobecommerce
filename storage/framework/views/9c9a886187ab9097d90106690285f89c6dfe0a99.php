                        ...
                        <ul class="top_menu">
                            ...
                            <li><a href="#">Track my order</a></li>
                             <?php if(isset($logged_userinfo) && !empty($logged_userinfo)): ?>
								<li><a href="<?php echo e(route('ecom.account.profile')); ?>"><?php echo e(isset($logged_userinfo->full_name) ? $logged_userinfo->full_name : ''); ?></a></li>
							<?php else: ?>
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-3 col-md-12">
                            <div class="logo mb-all-30">
                                <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('resources/assets/themes/shopping/img/logo/logo.png')); ?>" alt="logo-image"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
								...
								<ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
										<li><a href="<?php echo e(route('ecom.product.cart-items-view')); ?>"><i class="lnr lnr-cart"></i><span class="my-cart"><span class="total-pro cart_total_quatity"></span><span>cart</span></span></a>
