...
class Images
{
    ...
    {       
        ...
        {
            $images->orderby('img.is_primary', 'DESC')->orderby('img.sort_order', 'ASC');
        }       
        $images->selectRaw('img.img_id as id,img.img_path,img.img_file,img.is_primary,img.sort_order,ims.file_path,img.relative_post_id,'
