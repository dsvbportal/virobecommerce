...
//                    }
    ...
    public function cancelled ($payment_type, $id)
    {
        ...
        $postdata =json_decode( '{"mihpayid":"403993715518701085","mode":"","status":"failure","unmappedstatus":"userCancelled","key":"gtKFFx","txnid":"387728b649faf76d9499","amount":"7500.00","discount":"0.00","net_amount_debit":"0.00","addedon":"2018-12-08 10:09:46","productinfo":"Package Starter Purchase amp 8377 7 500.00","firstname":"dsvb","lastname":"","address1":"","address2":"","city":"","state":"","country":"","zipcode":"","email":"dsvbdirect105@virob.com","phone":"","udf1":"1","udf2":"","udf3":"","udf4":"","udf5":"","udf6":"","udf7":"","udf8":"","udf9":"","udf10":"","hash":"7f96ba2aee5ee624ee4b11b7cbd36c9cc9f0dc551c2d61f1ad270c215c8d403f54475136324ee5cbd9216415f96e42473c143fc0dfcea3a2cc23a24cf0c91d16","field1":"","field2":"","field3":"","field4":"","field5":"","field6":"","field7":"","field8":"","field9":"Cancelled by user","payment_source":"payu","PG_TYPE":"","bank_ref_num":"","bankcode":"","error":"E1605","error_Message":"Transaction failed due to customer pressing cancel button."}');
        
		$pgr['response'] = $postdata;
		switch ($payment_type)
        {
            case 'pay-u':
