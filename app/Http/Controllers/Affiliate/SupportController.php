...
class SupportController extends AffBaseController {
	...
	*/
	...
	{		
		$post['account_type_id'] = $this->userSess->account_type_id;
		$data['faqs'] = $this->supObj->get_faqs($post);	
		return view('affiliate.support.faq_post',$data);
	}
		
	public function downloads ()
    {				
		$data['downloadlist'] = $this->supObj->get_anouncements($doctype = config('constants.ON'));
       	return view('affiliate.support.downloads',$data);
    }
	
	public function announcements()
    {
		$data['announcementList'] = $this->supObj->get_anouncements($doctype = config('constants.OFF'));	
