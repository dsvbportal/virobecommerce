    ...
    {	
        ...
        switch ($langKey)
        {
            ...
            case 'change-pwd':
                $msgSec = '
				var $val_message  = {
					    old_user_pwd: "'.trans('affiliate/settings/change_pwd_js.old_pwd').'",
						newpassword: {
							required: "'.trans('affiliate/settings/change_pwd_js.new_pwd').'",
							minlength: "'.trans('affiliate/settings/change_pwd_js.minlength').'"
						},
						confirmpassword: {
			...
			var $email_validate_message  = {
				 email: {
				  ...
				  tpin:{
					 required: "'.trans('affiliate/validator/change_email_js.tpin_not_empty').'",
					 minlength: "'.trans('affiliate/validator/change_email_js.minlengt').'",					
					 maxlength: "'.trans('affiliate/validator/change_email_js.maxlengt').'"
				  },
				  verify_code: {
			...
			var $chgpin_val_message  = {
				oldpassword: "'.trans('affiliate/settings/security_pwd_js.tran_oldpassword').'",
                tran_newpassword: {
				...
				tran_confirmpassword: {
					...
					equalTo: "'.trans('affiliate/settings/security_pwd_js.different_sec_pwd').'",
				}
			};
			...
			var $changeotp_val_message  = {
				otp: "'.trans('affiliate/settings/security_pwd_js.otp_req').'",
				minlength: "'.trans('affiliate/settings/security_pwd_js.otpminlen').'",
                maxlength: "'.trans('affiliate/settings/security_pwd_js.otpmaxlen').'",
			};
            var $wrong_msg = "'.trans('affiliate/general.something_wrong').'";
			var $processing="'.trans('affiliate/general.processing_txt').'";
			var $update="'.trans('affiliate/general.update_txt').'"
            ...
            to_account:  "'.trans('affiliate/wallet/fundtransfer_js.to_uname').'",
