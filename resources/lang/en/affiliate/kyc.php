<?php
 return[
	...
	'submit_btn' => 'SUBMIT',
	'personal_id_proof_desc'=>'In accordance with the industry standards and anti-money laundering regulations, Virob requires all clients to provide their Personal information that must be confirmed by the supporting documents you send us.',
	'address_id_proof_desc'=>'In accordance with the industry standards and anti-money laundering regulations, Virob requires all clients to provide their current Physical Residential Address. Client\'s residential address must be real and confirmed by the supporting documents you send us.',
	'tax_id_proof_desc'=>'In accordance with the industry standards and anti-money laundering regulations, Virob requires all clients to provide their PAN Card and Tax Identification Number information that must be real and confirmed by the supporting documents you send us.',		
	
	'file_valid_msg' => "Please select a file",
	'doc_type_valid_msg' => "Please Select a document type",
	'submit_btn_txt'=> 'SUBMIT',
	'address_proof'=>'Address Proof uploaded Successfully',
	'id_proof'=>'Id Proof  uploaded Successfully',
	'pan'=>'PAN document uploaded Successfully',
	'cheque'=>'Cancelled Cheque uploaded Successfully',
