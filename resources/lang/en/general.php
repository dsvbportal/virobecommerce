...
return [
    'actions'=>[
        ...
        'status'=>['1'=>':label Activated Successfully', '0'=>':label Deactivated Successfully'],
    ...
    'mobile_no_email_not_registered'=>'Mobile No/Email ID not registered',
...
has a 'single sign-on' policy. Any changes will reflect in your Seller account also.</p>",
    ...
    'verification_code_has_been_sent_to_yo_mobile_no'=>'One Time Password (OTP) has been sent to your Mobile No.',
	...
	'package_purchase_remarks'=> 'Package :package Purchase :amount',
    ...
    'fields'=>[
        ...
        'supplier_agree'=>'If you have read and agree to the Terms and Conditions, Please Continue.',
        'timing'=>'Timing',
	...
	'store_timings_web'=>[
        'always'=>'<ul><li><b>Always</b></li></ul>',
        'closed'=>'<span>:days</span> - Closed',
        'splited_close'=>':days',
        'split'=>'<span>:days:</span> :from_time - :to_time',
        'splited_time'=>':days</li><li><span>&nbsp;</span> :from_time - :to_time',
    ],
	'outlets'=>'Outlet',
	...
	'withdraw_title'=>'Withdraw fund to :payment_type (Trans.ID: #:trans_id)',
	'bonus_status' => [0=>'Pending',1=>'Relesed',5=>'Waiting',4=>'Lapsed'],	
	'transactions'=>[
        'status'=>[
            1=>'Confirmed',
            0=>'Pending',
	...
	'fr_type'=>[
		1=>'Country Chennal Partner',
		2=>'Regional Chennal Partner',
		3=>'State Chennal Partner',
		4=>'District Chennal Partner',
		5=>'City Chennal Partner'
	],
	'session_expire'=>"The password reset link was invalid / expired (valid for 5 minutes), possibly because it has already been used. Please request a new password reset",
];
