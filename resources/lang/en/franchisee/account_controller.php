...
return [
    ...
    'account_activated'=>['title'=>"Congratulations", 'desc'=>"<h1 class='text-success'>Congratulations!</h1><p>Your account has successfully activated. You can login now</p>"],
	'signup_activation'=>['title'=>"Congratulations", 'desc'=>"<h1 class='text-success'>Congratulations!</h1><p>Your account created successfully, To activate your account we've sent an email to verify your email address. Please check your inbox.</p>"],
	'signup_verification'=>"We've sent an email to completed your registration. Please check your inbox.",
    ...
    /* 'could_not_process_req'=>'Sorry your request could not be processed at the moment. please try again later', */
     'could_not_process_req'=>'Please upload the document',
	...
	'invalid_emailverify_link' =>  "Invalid Verification Link",
	'email_verified'=>'Congratulations your email address successfully verified!',
];
