...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="border-collapse: collapse;" width="600"><!--start title-->
    <tbody>
        <tr>
			...
			<singleline label="title" style="margin-right:400px"> Dear  <?php echo $name; ?>,</singleline>
			</td>
		</tr>
<tr>
...
<multiline label="content1">
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Hii,</p>
     <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Greetings!</p>
      <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">You are just a step away from accessing your Virob seller account,</p>
      <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">This is to ensure that only you have access to your account.</p>
	  <br>
	  <a href="<?php echo $url; ?>"><button class="btn btn-default"> Click Here to Verify</button></a>
