...
<div style="">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="border-collapse: collapse;" width="600">
        <thead>
            <tr><td style="padding: 1em 0em;"><a href="{{URL::to('/')}}" style="color: #3291db;text-decoration: none;outline: none;"><img  src="<?php echo URL::asset('resources/assets/imgs/logo.png');?>" style="border: 0px; display: block; width: 200px; height: 80px;"></a></td></tr>
        </thead>
        <tbody>
            <tr>
