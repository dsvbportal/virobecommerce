...
@section('title','Payment Received Notification')
@section('content')
<tr>
...
<tr>
	<td style="font-size:13px;color:#929292" align="center">Just thought you'd like to know <b>{{$from_full_name}}</b>({{$from_user_code}}) sent you <b>{{$amount.' '.$currency}} -  {{$transfer_remarks}}</b>.</td>
</tr>
<tr>
	<td width="40">&nbsp;</td></tr>
<tr>
