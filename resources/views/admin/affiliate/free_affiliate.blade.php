	...
	<div class="col-md-12" id="users-list-panel">
        <div class="panel panel-default" id="list">
            <div class="panel-heading">
                <h4 class="panel-title">Free Affiliate</h4>
            </div>
            <div class="panel_controls">
                <div class="row">
                    <form id="manage_user_details" action="{{route('admin.aff.free_affiliate')}}" method="get">
...
<script src="{{asset('js/providers/admin/affiliate/free_affiliate.js')}}"></script>
@stop
