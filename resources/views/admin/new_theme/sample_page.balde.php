...
<div class="col-md-8 col-md-offset-3 sectioncls ">
<div class="heading text-center">ADD AFFILIATE (ROOT ID)
  ...
  <div class="form-group ">
                 ...
                 <option value="Afghanistan">Gender</option>              
                <option value="Afghanistan">Male</option>
                <option value="Åland Islands">Female</option>
                  <option value="Åland Islands">Other</option>
                </select>
  ...
  <div class="col-md-6">
           ...
           <div class="form-group">
                     ...
                     <input required name="Lastname" type="text" class="form-control " placeholder="Lastname" >
                      ...
                      <input required name="login[username]" type="text" class="form-control" placeholder="Username" >
                            <span></span>    
                            
                          <div class="col-md-6  foradjust"> 
                                         
	<input placeholder="DOB (YYYY-MM-DD)" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
               <!--<input placeholder="Date" class="textbox-n form-control" type="date" onfocus="(this.type='date')"  id="date">-->
               <!--<input placeholder="Your Date" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date">-->
                     ...
                     <span></span>   
                       ...
                       <input required name="Zipcode" type="text" class="form-control" placeholder="Zip/Pin Code" >
                            <span></span> 
                            
                       </div>
      
                           <div class="col-md-12 lastpart">  
      ...
      <input type="tel" id="phone" class="form-control" placeholder="Enter Mobile Number" >
                       ...
                       <input name="" type="button" class="btnlast1" value="save">
                       </div>
                      </div>        
