...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link rel="stylesheet" href="{{asset('resources/assets/admin/css/ionicons.min.css')}}">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
		...
		<script src="{{asset('http://50.28.18.145/admin_design/resources/assets/admin/js/lib/iCheck/jquery.icheck.min.js')}}"></script>
