...
@section('title',trans('admin/finance.affiliate_credit_debit'))
@section('breadcrumb')
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title col-sm-6">Affiliate Credit & Debit </h4>
	</div>
	<div class="panel-body">
		<div id="status_msg"></div>
		<form id="search_form" class="form-horizontal form form-bordered" class="" autocomplete="off" action="{{route('admin.finance.fund-transfer.find_affiliate')}}" method="post">
