        ...
        <div class="col-sm-12">
            <div class="panel panel-default" id="list">
                <div class="panel-heading">
                    <h4 class="panel-title col-sm-6">Franchisee Kyc Verification </h4>
                </div>
                <div class="panel_controls">
                    <div class="row">
                        <form id="verification_docs_list" action="{{route('admin.franchisee.kyc-verification')}}">
                            <div class="col-sm-3">
...
@stop
@section('scripts')
<script src="{{asset('js/providers/admin/franchisee/kyc_verification.js')}}"></script>	
@stop
