	...
	<div id="users-list-panel">
		<div class="panel panel-default" id="list">
			<div class="panel-heading">
				<h4 class="panel-title">Merchant Enrolment Fee</h4>
			</div>
			<div class="panel_controls">
				<div class="row">
					<form id="merchant_enrol_fee" action="{{route('admin.franchisee.mer_enrollment_fee')}}" method="get">
			...
			<div class="panel-body no-padding">
				<div id="msg"></div>
				<table id="merchant_enrolment_fee" class="table table-striped">
					<thead>
						 <tr>
                                <th>Created On</th>
...
@stop
@section('scripts')
<script src="{{asset('js/providers/admin/franchisee/merchant_enrolment_fee.js')}}"></script>
@stop
