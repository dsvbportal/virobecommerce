<div id="change_email"  class="panel panel-default" style="display:none">
    ...
    <div class="panel-body">       
		<form action="{{route('admin.franchisee.change-email')}}" method="post" class="form-horizontal form-bordered" id="change_email_form" autocomplete="off" novalidate="novalidate">
			...
			<fieldset>
				<div class="form-group">
					<label class="col-sm-3 control-label">{{trans('admin/franchisee/settings/changepwd.current_email')}}</label>
					<div class="col-sm-6" style="margin-bottom: 0px;padding: 6px 15px 0px 15px;">
						<strong class="" id="old_emails"></strong>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">{{trans('admin/franchisee/settings/changepwd.new_email')}}</label>
					<div class="col-sm-3">
