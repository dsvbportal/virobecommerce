        ...
        <div class="col-sm-12">
            <div class="panel panel-default" id="list">
                <div class="panel-heading">
                    ...
                    <button type="button" id="create_brand" class="btn btn-success btn-sm pull-right"><span class="fa fa-plus"></span>Create Brand</button>
                </div>
                ...
                <div class="panel panel-default mrT0">
                    <div class="panel-heading">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-success btn-sm" title="Save"><span class="fa fa-save"></span></button>
