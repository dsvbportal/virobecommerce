	...
	<div class="col-md-12" id="users-list-panel">
        <div class="panel panel-default" id="list">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Car bonus</h4>
            </div>
            <div class="panel_controls">
                <div class="row">
	                  <form id="car_bonus_details" class="form form-bordered" action="{{route('admin.commission.car')}}" method="post">
                       		{!! csrf_field() !!}
            ...
            <div id="msg"></div>
				<table id="car_bonus_commission" class="table table-bordered table-striped" data-rank-url="{{route('admin.commission.rank_log')}}">
				   <thead>
						<tr>                                                    
...
@stop
@section('scripts')
	<script src="{{asset('js/providers/admin/report/car_bonus.js')}}"></script>
@stop