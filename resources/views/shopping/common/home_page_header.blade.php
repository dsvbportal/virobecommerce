                ...
                <div class="container">
                    ...
                    <div class="header-top">
                        <ul class="top_menu">
                            ...
                            <li><a href="#">{{$logged_userinfo->full_name or ''}}</a></li>
                            @else
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-2 col-md-12">
                            <div class="logo mb-all-30">
                                <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('resources/assets/themes/shopping/img/logo/logo-white.png')}}" class="white-logo" alt="">
                                  <img src="{{asset('resources/assets/themes/shopping/img/logo/logo.png')}}" class="logo" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="slider-wrapper theme-default">
                          ...
                          <!-- Vertical Menu End Here -->
                            ...
                            <div id="slider" class="nivoSlider">
                                <a href="shop.html"><img src="{{asset('resources/assets/themes/shopping/img/slider/4.jpg')}}" data-thumb="img/slider/1.jpg" alt="" title="#htmlcaption" /></a>
                                <a href="shop.html"><img src="{{asset('resources/assets/themes/shopping/img/slider/3.jpg')}}" data-thumb="img/slider/2.jpg" alt="" title="#htmlcaption2" /></a>
                            </div>
                            <!-- Slider Background  Image Start-->
                        </div>
                    </div>
