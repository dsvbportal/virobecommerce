            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-3 col-sm-6">
                    <ul class="main-thumb-desc nav tabs-area">
                        ...
                        <li><a data-toggle="pill" href="#menu1"  id='change_mobile_tab' ctr_url="{{route('ecom.account.change-mobile')}}">Change Mobile</a></li>
                        <li><a data-toggle="pill" href="#menu2" id="change_email_tab" ctr_url="{{route('ecom.account.change_email')}}">Change Email</a></li>
                    </ul>
