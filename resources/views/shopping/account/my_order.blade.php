...
@include('shopping.common.datatable_js')
@stop
@section('scripts')
	<script src="{{asset('validate/lang/order_list')}}" charset="utf-8"></script>
	<script type="text/javascript" src="{{asset('resources/assets/themes/ecom/lib/fxss-rate/rate.js')}}"></script>
	<script type="text/javascript" src="{{asset('js/providers/ecom/account/order.js')}}"></script>
@stop
