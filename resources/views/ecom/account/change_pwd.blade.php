        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-body">    
					<p><i class="fa fa-info-circle"></i> It's a good idea to use a strong password that you don't use elsewhere.</p><br>
					<form class="form-horizontal" id="change_pwdfrm" action="{{route('ecom.account.update-pwd')}}" method="post" autocomplete="off">
						<div class="form-group">					
							<label class="col-sm-3 control-label">Current Password<span class="danger">*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label">New Password<span class="danger">*</span></label>		
							<div class="col-sm-6">		
                                <div class="input-group">							
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="new_password_confirmation">Confirm Password<span class="danger">*</span></label>
							<div class="col-sm-6">	
                                <div class="input-group">								
