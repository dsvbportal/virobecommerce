...
@section('page-type','product-list')
@section('page')
        ...
        <div class="row">
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                ...
                <div class="col-left-slide left-module">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1500px, 0px, 0px); transition: all 0s ease 0s; width: 2100px;"><div class="owl-item cloned" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left2.jpg" alt="slide-left"></a></li></div><div class="owl-item cloned" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left3.png" alt="slide-left"></a></li></div><div class="owl-item" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left.jpg" alt="slide-left"></a></li></div><div class="owl-item" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left2.jpg" alt="slide-left"></a></li></div><div class="owl-item" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left3.png" alt="slide-left"></a></li></div><div class="owl-item cloned active" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left.jpg" alt="slide-left"></a></li></div><div class="owl-item cloned" style="width: 270px; margin-right: 30px;"><li><a href="#"><img src="assets/data/slide-left2.jpg" alt="slide-left"></a></li></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style="display: none;"><i class="fa fa-angle-left"></i></div><div class="owl-next" style="display: none;"><i class="fa fa-angle-right"></i></div></div><div class="owl-dots" style=""><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div></div></div></ul>
                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1032px, 0px, 0px); transition: all 0.3s ease 0s; width: 1806px;"><div class="owl-item cloned" style="width: 228px; margin-right: 30px;"><li>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="category-slider">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2610px, 0px, 0px); transition: all 0.3s ease 0s; width: 5220px;"><div class="owl-item cloned" style="width: 870px; margin-right: 0px;"><li>
                            <img src="assets/data/category-slide.jpg" alt="category-slider">
                        </li></div><div class="owl-item cloned" style="width: 870px; margin-right: 0px;"><li>
                            <img src="assets/data/slide-cart2.jpg" alt="category-slider">
                        </li></div><div class="owl-item" style="width: 870px; margin-right: 0px;"><li>
                            <img src="assets/data/category-slide.jpg" alt="category-slider">
                        </li></div><div class="owl-item active" style="width: 870px; margin-right: 0px;"><li>
                            <img src="assets/data/slide-cart2.jpg" alt="category-slider">
                        </li></div><div class="owl-item cloned" style="width: 870px; margin-right: 0px;"><li>
                            <img src="assets/data/category-slide.jpg" alt="category-slider">
                        </li></div><div class="owl-item cloned" style="width: 870px; margin-right: 0px;"><li>
