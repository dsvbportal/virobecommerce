        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-controls with-border">
                    <form id="car_bonus_details" class="form form-bordered" action="{{route('aff.reports.car_bonus')}}" method="post">
                        {!! csrf_field() !!}
                        <div class="col-sm-3">
                ...
                <div class="box-body">
                    <table id="car_bonus_commission" class="table table-bordered table-striped">
                        <thead>
                            <tr>
...
<script src="{{asset('js/providers/affiliate/bonus/car_bonus.js')}}"></script>
@stop
