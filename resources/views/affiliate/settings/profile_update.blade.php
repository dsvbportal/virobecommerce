<form class="form-horizontal" id="profileUpdateFrm" action="{{route('aff.settings.update_profile')}}" enctype="multipart/form-data">	
	<div class="form-group">
		<label class="col-sm-3 control-label">Account ID</label>
		<div class="col-sm-9">
		    <label class="control-label">{{$user_code}}</label>			
		</div>
	</div>
	<div class="form-group">
