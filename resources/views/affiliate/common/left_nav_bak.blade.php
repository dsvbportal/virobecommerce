      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('aff.referrals.mydirects')}}"><i class="fa fa-circle-o"></i>My Directs </a></li>			
            <li><a href="{{route('aff.referrals.myteam')}}"><i class="fa fa-circle-o"></i>My Generation Report</a></li>
...
<li><a href="{{route('aff.referrals.refer-and-earn')}}"><i class="fa fa-circle-o"></i>Refer & Earn</a></li>			
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">            
            ...
            <li><a href="{{route('aff.reports.ambassador_bonus')}}"><i class="fa fa-circle-o"></i>Ambassador Bonus </a></li>
            ...
            <li><a href="{{route('aff.reports.car_bonus')}}"><i class="fa fa-circle-o"></i>Car Bonus</a></li>            
            <li><a href="{{route('aff.reports.start_bonus')}}"><i class="fa fa-circle-o"></i>Star Bonus</a></li>            
            <li><a href="{{route('aff.reports.ranks')}}"><i class="fa fa-circle-o"></i>Rank</a></li>            
          </ul>
        </li>
        <li class="treeview">
