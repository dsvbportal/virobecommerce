                ...
                <article class="pricing-column col-sm-3 col-md-4  col-lg-3">
                    <div class="inner-box card-box">
                        ...
                        <div class="package_more_section"><a href="#" class="closeBtn">{{trans('affiliate/package.buypack_closebtn')}} <i class="fa fa-close"></i></a>
                            <p>{{$pack->description}}
                            <?php                             
                                $str = '<li> Shopping Points (Cashback): '.number_format($pack->shopping_points_cashback,2,',','.').'</li>';
								$str = '<li> Shopping Points (Bonus): '.number_format($pack->shopping_points_bonus,2,',','.').'</li>';
