            ...
            <div class="col-md-12">
                <div class="panel panel-default" id="payment-list">
                    ...
                    <div class="panel_controls">
                        <div class="row">
                            <div class="col-md-8">
                                <div id="payout-types"  data-url="<?php echo url('affiliate/withdrawal/payout')?>" >
                                </div>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="panel panel-default" id="withdrawal-form-panel" style="display: none;">
                    ...
                    <div class="panel-body">
                        <form class="form form-horizontal" id="withdrawal-form"  data-url="<?php echo url('affiliate/withdrawal/payout-details')?>" action= "<?php echo url('affiliate/withdrawal/save')?>" >
                            ...
                            <div id="account-details">
                                ...
                                <div class="form-group account-details express-withdrawal wire-transfer INR" style="display: none;">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" name="account_details[b_bankname]" id="b_nickname"/>
                                    </div>
                                </div>
                                <div class="form-group account-details express-withdrawal wire-transfer INR" style="display: none;">
