<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
		...
		@if(Route::currentRouteName()=='fr.dashboard')
		<div class="top-cont" style="float: left; margin-left: 10px;"><h3 syle="font-size:20px;">Welcome to Dashboard</h3></div>
		@endif
		...
		@if(Route::currentRouteName()=='fr.dashboard')
		<div class="row">
			<div class="col-sm-12"  style="background: #ffffff;margin: 5px 10px -10px 0px;">
				<div class="pull-right">
					<h5><i class="fa fa-clock-o"></i> <span class="text-muted">Your Last Login:</span> {{$userSess->last_logged_time}}</h5>
				</div>
				<h5>Your Relationship Manager : <b class="text-info">{{$userSess->full_name}}</b></h5>
			</div>
		</div>
		@endif
    </nav>	
