...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>{{trans('franchisee/general.Withdrawal')}}</li>
        ...
        <div class="box box-primary tabs" id="payout-amt-info" style="display:none">
            <div class="box-header with-border flds">
                ...
                <div class="panel-body">					
						<div id="msg"></div>
                    <form class="form form-horizontal" id="withdrawal-form" action="{{route('fr.withdrawal.payout_withdraw_settings')}}">
					...
					@if(!empty($balance))
					<form class="form form-horizontal" id="trans_pin_form" action="{{route('fr.withdrawal.save_withdrawal')}}" style="display:none">
						<div class="form-group">
...
@stop
@section('scripts')
<script src="{{asset('js/providers/franchisee/withdrawal/withdrawal_request.js')}}" type="text/javascript" charset="utf-8"></script>
