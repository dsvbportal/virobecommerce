<table class="table table-dark-bordered  table-dark-striped"  id="bank_details_main">
    ...
    <tr>
		<td>
			<form class="form-horizontal" id="bank_details" action="{{route('fr.settings.bank-details')}}" enctype="multipart/form-data" data-bank-info="{{route('fr.settings.bank-info')}}">				
				 <div id="add_details" <?php echo empty($bank_account_details)? "style='display:block'": "style='display:none'";?>>				 
					...
					<div class="form-group">
						<label for="inputEmail" class="col-sm-4 control-label"> Your Account Number</label>
						<div class="col-sm-4">
