...
@section('title','Merchants Due')
@section('content')																																					
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><i class="fa fa-home"></i>Merchant's Due</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{\trans('franchisee/dashboard.page_title')}}</a></li>
        <li>Merchant's Due</li>
							...
							<div class="input-group">
								...
								<div class="input-group-btn">
									...
									<ul class="dropdown-menu  dropdown-menu-form dropdown-menu-right" id="chkbox">
											<li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="merchant_code" type="checkbox" checked>	&nbsp;{{trans('franchisee/merchant/merchant_details.merchant_code')}}</label>
											</li>
											<li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="merchant_name" type="checkbox">	&nbsp;{{trans('franchisee/merchant/merchant_details.merchant_name')}}</label>
											</li>
											<li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="merchant_mobile" type="checkbox">	&nbsp;{{trans('franchisee/merchant/merchant_details.mobile')}}</label>
											</li>
											<li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="merchant_email" type="checkbox">	&nbsp;{{trans('franchisee/merchant/merchant_details.email')}}</label>
											</li>
											<li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="merchant_uname" type="checkbox">	&nbsp;{{trans('franchisee/merchant/merchant_details.uname')}}</label>
											</li>
										</ul>
								</div>
							</div>
