        ...
        <div class="col-sm-12">
            <div class="box box-primary" id="report">
                <div class="box-header with-border">
                    <form id="earned_commissionfrm_details" class="form form-bordered"  method="post">  
                ...
                <div class="box-body">
                    <table id="earned_commission_tbl_details" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Created On</th>
								<th>Receiver</th>
...
<script src="{{asset('js/providers/franchisee/reports/earned_commission_details.js')}}"></script>
@stop
