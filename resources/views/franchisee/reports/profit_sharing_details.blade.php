    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary" id="report">
              ...
              <!--      <form id="profit_sharing_form" class="form form-bordered"  method="post">  
                ...
                <div class="box-body">
                    <table id="profit_sharing_details" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Date</th>
								<th>Sales Amount</th>
...
<script src="{{asset('js/providers/franchisee/reports/profit_sharing_details.js')}}"></script> 
@stop
