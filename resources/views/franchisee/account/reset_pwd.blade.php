...
<div class="login-box signin" style="width:500px">	
	...
	<div class="login-box-body">
		...
		<form id="password-resetfrm" action="{{route('fr.pwdreset-save')}}" method="post">			
			...
			<div class="form-group">				
				<div class="input-group">   <!-- pattern="/^\S{6,20}$/" data-patternmismatch="New Password must 6 to 20 characters"-->
					<input name="newpassword" id="newpassword" title="New Password" placeholder="New Password"  is_editable="0" is_visible="0" type="password" class="form-control"  data-err-msg-to="#newpwd_err" onkeypress="return RestrictSpace(event)" maxlength="16">
			...
			<div class="form-group">
				<div class="input-group">  
					<input name="confirmpassword" id="confirmpassword" title="Confirm New Password" placeholder="Confirm New Password" is_editable="0" is_visible="0" type="password" class="form-control" data-err-msg-to="#confirm_newpwd_err" onkeypress="return RestrictSpace(event)" maxlength="16">
    ...
    <a href="{{route('fr.login')}}">Login with your account</a>    
	</div>
		@endif
		@if(!$pwd_resetfrm)
		{{$msg}}
