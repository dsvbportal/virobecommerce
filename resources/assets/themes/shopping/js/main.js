...
(function ($) {
    ...
    $(document).ready(function(){
		$(".forgot-pass").click(function(){
			...
			$(".forgot-panel").show("fast");
			$('#forgot_pwd .send-verification').show('slow');		
            $('.send-link-success,.resend-link', '#forgot_pwd').hide('fast');
			$('#forgot_pwd .resend-link').attr('data-uname','');			
		    $('#forgot_pwd input').val('');
		});
		$(".back-login").click(function(){
		    $(".login-panel").show("fast");
		    $(".forgot-panel").hide("fast");
			$('#forgot_pwd .send-verification').show('slow');		
            $('.send-link-success,.resend-link', '#forgot_pwd').hide('fast');
			$('#forgot_pwd .resend-link').attr('data-uname','');			
		    $('#forgot_pwd input').val('');
    ...
    $('.categorie-title,.mobile-categorei-menu').on('mouseover', function () {
