...
if (isset($_REQUEST['img']) && !empty($_REQUEST['img']) && (file_exists($_REQUEST['img']) || (isset($_REQUEST['other']) && $_REQUEST['other'])))
{
    $imageName = $_REQUEST['img'];
}
else
{   
    if (strpos($_REQUEST['img'], 'profile') > -1)
    {
        $imageName = 'resources/uploads/account/profileimg/blank.png';
    }
    elseif (strpos($_REQUEST['img'], 'imgs/stores') > -1)
    {
        $imageName = 'resources/uploads/stores/store.png';
    }
	elseif (strpos($_REQUEST['img'], 'imgs/merchant-gallery') > -1)
    {
        $imageName = 'resources/uploads/merchant/your-logo-here.png';
    }
}
