...
return [		
		...
		'sign-up'=>[
			...
			'RULES'=>[
				...
				'account_mst.mobile'=>'required|regex:/^[0-9]{10}$/|unique:'.Config::get('tables.ACCOUNT_MST').',mobile,NULL,account_id,account_type_id,'.Config::get('constants.ACCOUNT_TYPE.SELLER').',is_deleted,0',				
			...
			'update-account'=>[
				'ATTRIBUTES'=>[
					...
					'store_extras.working_days'=>[
						'options'=>Array ( ['label' => 'Sunday', 'attr'=>1], ['label' => 'Monday', 'attr'=>2], ['label' => 'Tuesday', 'attr'=>3], ['label' => 'Wednesday', 'attr'=>4], ['label' => 'Thursday', 'attr'=>5], ['label' => 'Friday', 'attr'=>6], ['label' => 'Saturday', 'attr'=>7]),						
						'type'=>'checkbox'
					]
					
				],
				'LABELS'=>[
					'store_extras.store_name'=>'Store Name',
					...
					'address.postal_code'=>Lang::get('general.fields.postal_code'),
					'address.city_id'=>Lang::get('general.fields.city'),
					'address.flatno_street'=>Lang::get('general.fields.street1'),
					'address.address'=>Lang::get('general.fields.street2'),
					'address.landmark'=>Lang::get('general.fields.street2'),
